...
Contributors: altimawebsystems.com
Tags: Slider, hotspot, hotpoint, buy, sell, commerce
Requires at least: 4.0
Tested up to: 4.4.2

Lookbook provide to create slider with different visual effects and add points to slider images.

== Description ==

Altima LookBook Free provides your visitors with "Shop the look" experience. First of all it is intended for online retailers who use WooCommerce. 
It is a simpler version of Professional Lookbooks plugin from Altima and provides the next functionality:

    *1. One slider.
    *2. Product name, link to product page, price and stock status in hotspot, also any link with text supported
    *3. Up to five lides per slider.
    *4. Up to three otspots per slide.
...
4. Depends from php mode (apache module, cgi, fpm-cgi) check write permissions for folder /wp-content/uploads
...
Professional version allows to create unlimited number of sliders, slides and hotspots and has other additional nice features. You can get it for $69 from http://shop.altima.net.au 
...
2. Tab "Lookbook Sliders"
    ...
    2.1 Edit slider
        ...
        Note: If you change slider or thumbnail dimensions it take effect for all already uploaded pictures.(of course if "Deny resize images" - in "No" state).
