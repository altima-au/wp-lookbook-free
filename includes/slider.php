...
function wpcycle_scripts_load() {
    wp_register_script( 'jquery_182', plugins_url( '/lookbook-free/admin/js/jquery-1.8.2.min.js' ) );
    wp_register_script( 'cycle2', plugins_url( '/lookbook-free/assets/js/cycle2/jquery.cycle2.min.js'), array( 'jquery_182' ) );
    wp_register_script( 'caption2', plugins_url( '/lookbook-free/assets/js/cycle2/jquery.cycle2.caption2.min.js'), array( 'cycle2' ) );
    wp_register_script( 'hotspots', plugins_url( '/lookbook-free/admin/js/hotspots.js') );
    wp_register_script( 'actual', plugins_url( '/lookbook-free/assets/js/jquery.actual.js') );
    wp_register_script( 'annotate', plugins_url( '/lookbook-free/admin/js/jquery.annotate.js') );
    wp_register_script( 'carousel', plugins_url( '/lookbook-free/assets/js/cycle2/jquery.cycle2.carousel.min.js') );
    wp_register_script( 'flip', plugins_url( '/lookbook-free/assets/js/cycle2/jquery.cycle2.flip.min.js') );
    wp_register_script( 'scrolV', plugins_url( '/lookbook-free/assets/js/cycle2/jquery.cycle2.scrollVert.min.js') );
    wp_register_script( 'shuffle', plugins_url( '/lookbook-free/assets/js/cycle2/jquery.cycle2.shuffle.min.js') );
    wp_register_script( 'tile', plugins_url( '/lookbook-free/assets/js/cycle2/jquery.cycle2.tile.min.js') );
    wp_register_script( 'additionalEffect', plugins_url( '/lookbook-free/assets/js/cycle2/jquery.cycle2.addEffects.js') );
    wp_register_script( 'swipe', plugins_url( '/lookbook-free/assets/js/cycle2/jquery.cycle2.swipe.min.js') );

    wp_register_style( 'lookbook', plugins_url( '/lookbook-free/assets/css/lookbook.css'), array(), '', 'all' );
}
...
add_action ('check_woocommerce', 'woocommerce_not_install_notice');

/**
 * @param $atts
 */
function slider_render_func($atts) {
    ...
    if (empty($slides)){
        ...
        add_hotspots($slides, $slider[0]['id']);
...
add_shortcode( 'slider_render', 'slider_render_func' );

function add_hotspots($slides, $slider_id) {
    foreach ($slides as $slide):
...
function thumbnails_js($slider_id) {
    ?>
    <script type="application/javascript">
