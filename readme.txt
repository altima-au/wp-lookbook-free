...
2. Tab "Lookbook Sliders"
    ...
    2.1 Edit slider
        ...
        "Deny resize images" - if you select "Yes" pictures will not resize after upload, it's have reason if you uploaded already prepared pictures for slider
		dimensions, otherwise for good result select option "No" and thumbnails will be resized automatically.
